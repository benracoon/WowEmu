...
int32 SpellEntry::CalculateSimpleValue(SpellEffIndex eff) const
{
...
SpellEffectEntry const* SpellEntry::GetSpellEffect(SpellEffIndex eff) const
{
...
uint32 SpellEntry::GetSpellEffectIdByIndex(SpellEffIndex index) const
{
...
uint32 SpellEntry::GetEffectImplicitTargetAByIndex(SpellEffIndex index) const
{
    SpellEffectEntry const* effect = GetSpellEffect(index);
...
int32 SpellEntry::GetEffectMiscValue(SpellEffIndex index) const
{
    SpellEffectEntry const* effect = GetSpellEffect(index);
    return effect ? effect->EffectMiscValue : 0;
}

int32 SpellEntry::GetEffectMiscValueB(SpellEffIndex index) const
{
    SpellEffectEntry const* effect = GetSpellEffect(index);
...
uint32 SpellEntry::GetEffectApplyAuraNameByIndex(SpellEffIndex index) const
{
    SpellEffectEntry const* effect = GetSpellEffect(index);
