...
{
    uint32    Id;                                           // 0 - m_ID
    uint32    CategoryRecoveryTime;                         // 2 - m_categoryRecoveryTime
    uint32    RecoveryTime;                                 // 3 - m_recoveryTime
    uint32    StartRecoveryTime;                            // 4 - m_startRecoveryTime
};
...
struct SpellEffectEntry
{
    ...
    float     EffectBonusCoefficient;                       // 6  - 3.2.0
...
struct SpellReagentsEntry
{
    ...
    uint32    ReagentCount[MAX_SPELL_REAGENTS];             // 2 - m_reagentCount
};
...
{
    uint32    Id;                                             // 0 - m_ID
    uint32    TotemCategory[MAX_SPELL_TOTEM_CATEGORIES];      // 1 - m_requiredTotemCategoryID
...
struct SpellEntry
{
    ...
    uint32    SpellVisual[MAX_SPELL_VISUAL];                // 17 - m_spellVisualID, 18 - m_spellVisualID1
