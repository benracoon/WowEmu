...
void OpcodeTableHandler::LoadOpcodesFromDB()
{
    ...
    QueryResult result = WorldDB.Query("SELECT OpcodeName, OpcodeValue FROM Opcodes WHERE ClientBuild > 0");
    if (!result)
        return;
...
void InitOpcodeTable()
{
    ...
    **************************************************************************************/
    ...
    /**************** AUTH CHECK ****************/
    /********************************************/
    OPCODE(MSG_RESUME_COMMS,      STATUS_NEVER, PROCESS_INPLACE, &WorldSession::HandleEarlyProccess);
    ...
    OPCODE(CMSG_REQUEST_RATED_BG_INFO,  STATUS_LOGGEDIN,    PROCESS_INPLACE, &WorldSession::HandleNULL                     );
    OPCODE(CMSG_REQUEST_PVP_OPTIONS_ENABLED, STATUS_LOGGEDIN,    PROCESS_INPLACE, &WorldSession::HandleNULL                );
    ...
    // Player Arena
    //OPCODE(CMSG_ARENA_TEAM_CREATE,               STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::HandleArenaTeamCreate );
    ...
    **************************************************************************************/
    ...
    OPCODE(SMSG_VENDOR_INVENTORY,                        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::HandleServerSide);
