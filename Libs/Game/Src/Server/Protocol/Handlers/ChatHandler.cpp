...
void WorldSession::HandleMessagechatOpcode(WorldPacket & recv_data)
{
    ...
    if(type == CHAT_MSG_AFK)
    {
        ...
        if ((msg.empty() || !_player->isAFK()) && !_player->isInCombat())
        {
            ...
            {
                if (msg.empty())
                    msg  = GetStrings(LANG_PLAYER_AFK_DEFAULT);
                _player->afkMsg = msg;
            }
    ...
    else if(type == CHAT_MSG_DND)
    {
        ...
        if (msg.empty() || !_player->isDND())
        {
            ...
            {
                if (msg.empty())
                    msg = GetStrings(LANG_PLAYER_DND_DEFAULT);
                _player->dndMsg = msg;
            }
    ...
    else
    {
        ...
        if (!sender->CanSpeak())
        {
            ...
            SendNotification(GetStrings(LANG_WAIT_BEFORE_SPEAKING),timeStr.c_str());
            return;
        }
    ...
    if (sender->HasAura(1852) && type != CHAT_MSG_WHISPER)
    {
        ...
        SendNotification(GetStrings(LANG_GM_SILENCE), sender->GetName());
        return;
    }
    ...
    case CHAT_MSG_YELL:
        {
            ...
            {
                SendNotification(GetStrings(LANG_SAY_REQ), sWorld->getIntConfig(CONFIG_CHAT_SAY_LEVEL_REQ));
                return;
            }
    ...
    case CHAT_MSG_WHISPER:
        {
            ...
            {
                SendNotification(GetStrings(LANG_WHISPER_REQ), sWorld->getIntConfig(CONFIG_CHAT_WHISPER_LEVEL_REQ));
                return;
            }
            ...
            {
                SendNotification(GetStrings(LANG_GM_SILENCE), GetPlayer()->GetName());
                return;
            }
    ...
    case CHAT_MSG_CHANNEL:
        {
            ...
            {
                SendNotification(GetStrings(LANG_CHANNEL_REQ), sWorld->getIntConfig(CONFIG_CHAT_CHANNEL_LEVEL_REQ));
                return;
            }
