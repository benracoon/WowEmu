...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_bool_configs[CONFIG_BOOL_MMAP_ENABLED] = sConfig->GetBoolDefault("MMaps.enabled", true);
    std::string ignoreMapIds = sConfig->GetStringDefault("MMaps.ignoreMapIds", "");
    MMAP::MMapFactory::preventPathfindingOnMaps(ignoreMapIds.c_str());
    sLog->outString("WORLD: mmap pathfinding %sabled", CONFIG_BOOL_MMAP_ENABLED ? "en" : "dis");
    ...
    m_bool_configs[CONFIG_SHOW_SCRIPTNAME_ERROR] = sConfig->GetBoolDefault("ScriptNameError.Show", false);
    m_bool_configs[CONFIG_SHOW_EMPTY_TABLE_ERROR] = sConfig->GetBoolDefault("EmptyTableError.Show", false);
