...
void Player::UpdateAttackPowerAndDamage(bool ranged)
{
    ...
    SetInt32Value(index_mod_neg, (uint32)attPowerMod);      //UNIT_FIELD_(RANGED)_ATTACK_POWER_MOD_POS field
...
void Guardian::UpdateAttackPowerAndDamage(bool ranged)
{
    ...
    SetInt32Value(UNIT_FIELD_ATTACK_POWER_MOD_NEG, (int32)attPowerMod);
