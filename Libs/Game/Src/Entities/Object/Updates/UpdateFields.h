...
enum UnitFields
{
    ...
    UNIT_FIELD_POWER1                                = OBJECT_END + 0x13,    // MANA, RAGE, ENERGY, RUNIC_POWER
    UNIT_FIELD_POWER2                                = OBJECT_END + 0x14,    // HOLY_POWER, SOUL_SHARDS
    UNIT_FIELD_POWER3                                = OBJECT_END + 0x15,    // FOCUS
    UNIT_FIELD_POWER4                                = OBJECT_END + 0x16,    // RUNES
    UNIT_FIELD_POWER5                                = OBJECT_END + 0x17,    // ECLIPSE
...
enum PlayerFields
{
    ...
    PLAYER_XP                                        = UNIT_END + 0x1E2,
    PLAYER_NEXT_LEVEL_XP                             = UNIT_END + 0x1E3,
    PLAYER_SKILL_INFO_1_1                            = UNIT_END + 0x1E4,
    PLAYER_CHARACTER_POINTS                          = UNIT_END + 0x364,
    PLAYER_TRACK_CREATURES                           = UNIT_END + 0x365,
    PLAYER_TRACK_RESOURCES                           = UNIT_END + 0x366,
    PLAYER_EXPERTISE                                 = UNIT_END + 0x367,
    PLAYER_OFFHAND_EXPERTISE                         = UNIT_END + 0x368,
    PLAYER_BLOCK_PERCENTAGE                          = UNIT_END + 0x369,
    PLAYER_DODGE_PERCENTAGE                          = UNIT_END + 0x36A,
    PLAYER_PARRY_PERCENTAGE                          = UNIT_END + 0x36B,
    PLAYER_CRIT_PERCENTAGE                           = UNIT_END + 0x36C,
    PLAYER_RANGED_CRIT_PERCENTAGE                    = UNIT_END + 0x36D,
    PLAYER_OFFHAND_CRIT_PERCENTAGE                   = UNIT_END + 0x36E,
    PLAYER_SPELL_CRIT_PERCENTAGE1                    = UNIT_END + 0x36F,
    PLAYER_SHIELD_BLOCK                              = UNIT_END + 0x376,
    PLAYER_SHIELD_BLOCK_CRIT_PERCENTAGE              = UNIT_END + 0x377,
    PLAYER_MASTERY                                   = UNIT_END + 0x378,
    PLAYER_EXPLORED_ZONES_1                          = UNIT_END + 0x379,
    PLAYER_REST_STATE_EXPERIENCE                     = UNIT_END + 0x409,
    PLAYER_FIELD_COINAGE                             = UNIT_END + 0x40A,
    PLAYER_FIELD_MOD_DAMAGE_DONE_POS                 = UNIT_END + 0x40C,
    PLAYER_FIELD_MOD_DAMAGE_DONE_NEG                 = UNIT_END + 0x413,
    PLAYER_FIELD_MOD_DAMAGE_DONE_PCT                 = UNIT_END + 0x41A,
    PLAYER_FIELD_MOD_HEALING_DONE_POS                = UNIT_END + 0x421,
    PLAYER_FIELD_MOD_HEALING_PCT                     = UNIT_END + 0x422,
    PLAYER_FIELD_MOD_HEALING_DONE_PCT                = UNIT_END + 0x423,
    PLAYER_FIELD_WEAPON_DMG_MULTIPLIERS              = UNIT_END + 0x424,
    PLAYER_FIELD_MOD_SPELL_POWER_PCT                 = UNIT_END + 0x427,
    PLAYER_FIELD_MOD_TARGET_RESISTANCE               = UNIT_END + 0x428,
    PLAYER_FIELD_MOD_TARGET_PHYSICAL_RESISTANCE      = UNIT_END + 0x429,
    PLAYER_FIELD_BYTES                               = UNIT_END + 0x42A,
    PLAYER_SELF_RES_SPELL                            = UNIT_END + 0x42B,
    PLAYER_FIELD_PVP_MEDALS                          = UNIT_END + 0x42C,
    PLAYER_FIELD_BUYBACK_PRICE_1                     = UNIT_END + 0x42D,
    PLAYER_FIELD_BUYBACK_TIMESTAMP_1                 = UNIT_END + 0x439,
    PLAYER_FIELD_KILLS                               = UNIT_END + 0x445,
    PLAYER_FIELD_LIFETIME_HONORBALE_KILLS            = UNIT_END + 0x446,
    PLAYER_FIELD_BYTES2                              = UNIT_END + 0x447,
    PLAYER_FIELD_WATCHED_FACTION_INDEX               = UNIT_END + 0x448,
    PLAYER_FIELD_COMBAT_RATING_1                     = UNIT_END + 0x449,
    PLAYER_FIELD_ARENA_TEAM_INFO_1_1                 = UNIT_END + 0x463,
    PLAYER_FIELD_BATTLEGROUND_RATING                 = UNIT_END + 0x478,
    PLAYER_FIELD_MAX_LEVEL                           = UNIT_END + 0x479,
    PLAYER_FIELD_DAILY_QUESTS_1                      = UNIT_END + 0x47A,
    PLAYER_RUNE_REGEN_1                              = UNIT_END + 0x493,
    PLAYER_NO_REAGENT_COST_1                         = UNIT_END + 0x497,
    PLAYER_FIELD_GLYPH_SLOTS_1                       = UNIT_END + 0x49A,
    PLAYER_FIELD_GLYPHS_1                            = UNIT_END + 0x4A3,
    PLAYER_GLYPHS_ENABLED                            = UNIT_END + 0x4AC,
    PLAYER_PET_SPELL_POWER                           = UNIT_END + 0x4AD,
    PLAYER_FIELD_RESEARCHING_1                       = UNIT_END + 0x4AE,
    PLAYER_FIELD_RESERACH_SITE_1                     = UNIT_END + 0x4B6,
    PLAYER_PROFESSION_SKILL_LINE_1                   = UNIT_END + 0x4BE,
    PLAYER_FIELD_UI_HIT_MODIFIER                     = UNIT_END + 0x4C0,
    PLAYER_FIELD_UI_SPELL_HIT_MODIFIER               = UNIT_END + 0x4C1,
    PLAYER_FIELD_HOME_REALM_TIME_OFFSET              = UNIT_END + 0x4C2,
    PLAYER_FIELD_MOD_HASTE                           = UNIT_END + 0x4C3,
    PLAYER_FIELD_MOD_RANGED_HASTE                    = UNIT_END + 0x4C4,
    PLAYER_FIELD_MOD_PET_HASTE                       = UNIT_END + 0x4C5,
    PLAYER_FIELD_MOD_HASTE_REGEN                     = UNIT_END + 0x4C6,
    PLAYER_FIELD_PADDING                             = UNIT_END + 0x4C7,
    PLAYER_END                                       = UNIT_END + 0x4C8
};
