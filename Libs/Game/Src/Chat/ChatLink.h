...
#ifndef STRAWBERRY_CHATLINK_H
#define STRAWBERRY_CHATLINK_H
...
public:
    ...
    virtual bool ValidateName(DBCString buffer, const char* context) = 0;
...
public:
    ...
    virtual bool ValidateName(DBCString buffer, const char* context);
...
public:
    ...
    virtual bool Initialize(std::istringstream& iss);
    virtual bool ValidateName(DBCString, const char* context);
