...
public:
    ...
    struct boss_victor_nefariusAI : public ScriptedAI
    {
        ...
        void BeginEvent(Player* target)
        {
            ...
            //Strawberry::Singleton<MapManager>::Instance().GetMap(me->GetMapId(), me)->GetPlayers().begin();
            /*
            ...
            if (SpawnedAdds < 42)
            {
                ...
                if (AddSpawnTimer <= diff)
                {
                    ...
                    if (SpawnedAdds >= 42)
                    {
                        ...
                        //Teleport self to a hiding spot (this causes errors in the Strawberry log but no real issues)
