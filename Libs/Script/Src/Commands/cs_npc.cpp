...
public:
    ...
    static bool HandleNpcSetFactionIdCommand(ChatHandler* handler, const char* args)
    {
        ...
        // and DB
        WorldDB.PExecute("UPDATE creature_template SET faction_A = '%u', faction_H = '%u' WHERE entry = '%u'", factionId, factionId, creature->GetEntry());
    ...
    static bool HandleNpcSetFlagCommand(ChatHandler* handler, const char* args)
    {
        ...
        WorldDB.PExecute("UPDATE creature_template SET npcflag = '%u' WHERE entry = '%u'", npcFlags, creature->GetEntry());
