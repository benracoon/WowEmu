...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand reloadCommandTable[] =
        {
            ...
            { "strings",               SEC_ADMINISTRATOR, true,  &HandleReloadStringsCommand,              "", NULL },
    ...
    static bool HandleReloadAllCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        HandleReloadStringsCommand(handler, "");
    ...
    static bool HandleReloadCreatureTemplateCommand(ChatHandler* handler, const char* args)
    {
        ...
        const_cast<CreatureTemplate*>(cInfo)->type_flags[0] = fields[42].GetUInt32();
    ...
    static bool HandleReloadStringsCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->outString("Re-Loading strings Table!");
        sObjectMgr->LoadStringss();
        handler->SendGlobalGMSysMessage("DB table `strings` reloaded.");
        return true;
    }
