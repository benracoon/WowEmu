                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_NATURE_BOMB:
                        {
                            ...
                            Strawberry::AnyPlayerInObjectRangeCheck checker(me, 50.0f);
                            Strawberry::PlayerListSearcher<Strawberry::AnyPlayerInObjectRangeCheck> searcher(me, PlayerList, checker);
